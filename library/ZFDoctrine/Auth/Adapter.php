 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class ZFDoctrine_Auth_Adapter implements Zend_Auth_Adapter_Interface
{
    /**
     * Database Connection
     *
     ...
     * @return ZFDoctrine_Auth_Adapter Provides a fluent interface
     */
    ...
    protected function _authenticateSetup()
    {
        ...
        if ($this->getConnection() === null) {
            ...
            $exception = 'A table must be supplied for the ZFDoctrine_Auth_Adapter authentication adapter.';
        } elseif ($this->_identityColumn == '') {
            $exception = 'An identity column must be supplied for the ZFDoctrine_Auth_Adapter authentication adapter.';
        } elseif ($this->_credentialColumn == '') {
            $exception = 'A credential column must be supplied for the ZFDoctrine_Auth_Adapter authentication adapter.';
        } elseif ($this->_identity == '') {
            $exception = 'A value for the identity was not provided prior to authentication with ZFDoctrine_Auth_Adapter.';
        } elseif ($this->_credential === null) {
            $exception = 'A credential value was not provided prior to authentication with ZFDoctrine_Auth_Adapter.';
        }
