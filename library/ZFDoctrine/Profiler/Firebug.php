 ...
 *
 * Original author: Imind Library
 *
 * @author tlw
 *
 */
class ZFDoctrine_Profiler_Firebug extends Doctrine_Connection_Profiler {
    ...
    protected function updateMessageLabel()
    {
        ...
        $this->_message->setLabel($this->_label . ' (' . $this->_queryCount . ' queries in ' . round($this->_totalElapsedTime,5) . ' sec)');
    }
}